...
class CallLogWindow:
    ...
    def __init__(self, parent, *args, **kwargs):
       ...
       # ----------------------------------------------------------------------------------------------------------
        ...
        self.tue_labelframe = self.create_labframe(self.display_frame, 'TUESDAY')
        self.tue_labelframe.grid(row = 2 ,padx = 3, pady = 3, sticky =  tk.NS)
        
        self.wed_labelframe = self.create_labframe(self.display_frame, 'WED')
        self.wed_labelframe.grid(row = 3, padx = 3, pady = 3, sticky =  tk.NS)
        
        self.thur_labelframe = self.create_labframe(self.display_frame, 'THURSDAY')
        self.thur_labelframe.grid(row = 4, padx = 3, pady = 3, sticky =  tk.NS)
        
        self.fri_labelframe = self.create_labframe(self.display_frame, 'FRIDAY')
