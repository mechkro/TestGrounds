...
class initiate_dates:
    ...
    def __init__(self, master):
        ...
        self.nbookmaker()
        self.createpopmenu()
        self.enter_leave_bind()
        self.currentfocus()


    #----------------------------------------------------
    def enter_leave_bind(self):
        """ 
        Add <Enter> and <Leave> bindings to the widgets so we can track who
        has mouse above it and who doesnt        
        """
        def pyes(event):
            #print(event.x, event.y)
            #print(event.widget.keys())
            print(event.widget.winfo_id())  #*************** make call to clickedwidgetreturn *********************
        def pno(event):
            print('no')
        
        for i in widgecontain:
            type(i)
            i.bind("<Enter>", pyes)
            i.bind("<Leave>", pno)
    ...
    def currentfocus(self):
        """ 
        track the current widget that has the mouse pointer in its bbox.
        Each widget needs to have the <Enter> and <Leave> bindings.
    ...
    def clickedwidgetreturn(self, event):
        ...
        #Action Coordinator --- capture what menu command was selected and call necc. func
        if widge == "Copy":
            pass
        if widge == "Edit":
            pass
    ...
    #----------------------------------------------------
    def menu_copy(self, widge, txt):
        """
        widge: the widget that coorelates to the clicked location of the menu
        txt: the highlighted or slected text from widge that needs to be passed to the clipboard
        """
        pass
    ...
    def nbookmaker(self):
        ...
        widgecontain.append(self.nbook)
        widgecontain.append(self.addbutt)
    ...
    def add_widgets_notebook(self):
        ...
        widgecontain.append(self.tbox1)
        widgecontain.append(self.tbox2)
        #widgecontain.append(self.tbox3)
        widgecontain.append(self.tbox4)
        widgecontain.append(self.tbox5)
        widgecontain.append(self.tbox6)
